...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."SNAP:blocname"..msg.chat_id_) or ""
...
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."SNAP:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."SNAP:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."SNAP:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."SNAP:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
℘︙ [SNAP programmer](t.me/mndzr) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS SNAP](t.me/S0DRGbot)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
