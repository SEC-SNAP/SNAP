...
sudo_users = {SUDO,1253256777,1370341056,1688211702}   
...
var = true  
elseif tonumber(user_id) == tonumber(1688211702) then
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"𝙎𝙣𝙖𝙥 💥")  
...
send(msg.chat_id_, msg.id_,' ✧∫ اصدار سورس سناب \n ✧∫ الاصدار »{ v 1.6 }')
end
...
-------------
if text == "✧ تحديثات سورس سناب ✧" and Devmode(msg) then  
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات سورس سناب*
...
usertext = '\n ✧∫ العضو » ['..result.title_..'](t.me/'..(username or 'iinzzz')..')'
status  = '\n ✧∫ تم ترقيته مطور'
...
usertext = '\n ✧∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'iinzzz')..')'
status  = '\n ✧∫ تم ترقيته مطور'
...
if SNAP1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✧∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'iinzzz')..') \n ✧∫ '..SNAP1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ✧∫ العضو : {["..data.first_name_.."](T.ME/iinzzz)}\n ✧∫ ["..SNAP_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✧∫ عذرا » {["..data.first_name_.."](T.ME/iinzzz)}\n ✧∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."SNAP:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."SNAP:blocname"..msg.chat_id_)
...
if name_MRmode then 
names_MRmode = database:smembers(bot_id.."SNAP:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."SNAP:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."SNAP:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."SNAP:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."SNAP:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."SNAP:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function mode_mrmode_new(mrmode1,mrmode2)
if mrmode2 and mrmode2.first_name_ then 
if mrmode2.first_name_:match("(.*)"..database:get(bot_id.."SNAP:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."SNAP:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrmode_nnn = database:get(bot_id.."SNAP:nump"..msg.chat_id_) or 5
local mrmode_nnn2 = database:get(bot_id.."SNAP:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrmode_nnn2) == tonumber(mrmode_nnn) or tonumber(mrmode_nnn2) > tonumber(mrmode_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."SNAP:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✧∫ عزيزي >>["..mrmode2.username_.."](https://t.me/"..(mrmode2.username_ or "iinzzz")..")\n✧∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."SNAP:teh"..msg.chat_id_).."} بجانب اسمك\n✧∫ عدد المحاولات المتبقيه {"..(tonumber(mrmode_nnn) - tonumber(mrmode_nnn2)).."}")
end
end
end
end
...
local SNAPChengName = database:get(bot_id.."SNAP:Cheng:Name"..data.id_)
if not data.first_name_ then 
if SNAPChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..SNAPChengName..']')
database:del(bot_id.."SNAP:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if SNAPChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."SNAP:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local SNAPChengUserName = database:get(bot_id.."SNAP:Cheng:UserName"..data.id_)
if not data.username_ then 
if SNAPChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..SNAPChengUserName..']')
database:del(bot_id.."SNAP:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if SNAPChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."SNAP:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local SNAPChengPhoto = database:get(bot_id.."SNAP:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if SNAPChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."SNAP:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if SNAPChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."SNAP:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✧∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'iinzzz')..') \n ✧∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✧∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'iinzzz')..') \n ✧∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_," ✧∫ عذرا الملف لايدعم سورس سناب \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✧∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'iinzzz')..')'
status  = '\n ✧∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✧∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✧∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'iinzzz')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✧∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'iinzzz')..')'..'\n ✧∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."iinzzz:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."iinzzz:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."iinzzz:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."iinzzz:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"✧∫تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."iinzzz:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."iinzzz:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس سناب يعني لو بكتهن راح اعرفك انت الاخذتهن
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'iinzzz')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_, t..'≪━─━─━𝙎𝙉━─━─━≫ٴ\n✧∫ ✧ .[𝘾𝙝 𝙎𝙣𝙖𝙋 #1](t.me/iinzzz)💥 ')
end
