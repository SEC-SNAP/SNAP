...
sudo_users = {SUDO,119541395,1253256777,1370341056,395244628}   
...
var = true  
elseif tonumber(user_id) == tonumber(395244628) then
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"سورس سنـاب")  
...
send(msg.chat_id_, msg.id_, t..'⊶────≺𝐒𝐍𝐏⁦≻────⊷ٴ\n⋄ :  ↬ .[💻📰┇𝙨𝙤𝙪𝙧𝙚𝙘𝙚𝙨 𝙨𝙣𝙖𝙗. ](t.me/iinzzz)✫ ')
end
